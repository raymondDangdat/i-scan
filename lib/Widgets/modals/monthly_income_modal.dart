              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ListView.builder(
                      ...
                      itemCount: monthlyIncomeOptions.length,
                      physics: const NeverScrollableScrollPhysics(),
                      shrinkWrap: true,
                      itemBuilder: (context, index) {
                        final monthlyIncome = monthlyIncomeOptions[index];
                        return Padding(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                                color: authProvider.selectedMonthlyIncome ==
                                        monthlyIncome
                                    ? black
                                    : white,
                            ...
                            child: InkWell(
                              onTap: () {
                                authProvider
                                    .updateSelectedMonthlyIncome(monthlyIncome);
...
final List<String> monthlyIncomeOptions = [
  "Less Than NGN100,000",
  "Between NGN100,000 And NGN500,000",
  "Between NGN500,0000 And NGN1,000,0000",
  "Between NGN1,000,000 And NGN1,500,000",
  "More Than NGN1,500,000",
];
