              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ListView.builder(
                      ...
                      itemCount: governmentIdType.length,
                      physics: const NeverScrollableScrollPhysics(),
                      shrinkWrap: true,
                      itemBuilder: (context, index) {
                        final occupation = governmentIdType[index];
                        return Padding(
                          ...
                          child: Container(
                            ...
                            child: InkWell(
                              onTap: () {
                                authProvider
                                    .updateSelectedDocumentForVerification(
                                        occupation);
...
final List<String> governmentIdType = [
  ninSlipDocumentType,
  votersCaredDocumentType,
  internationalPassportDocumentType,
  driversLicence,
];
