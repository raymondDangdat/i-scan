...
class PinUnfilled extends StatelessWidget {
  const PinUnfilled({Key? key}) : super(key: key);
...
class PinFilled extends StatelessWidget {
  const PinFilled({Key? key}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Container(
      width: 25.h,
...
class PassCodeFilled extends StatelessWidget {
  const PassCodeFilled({Key? key}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Container(
      width: 55.h,
...
class PasscodeUnfilled extends StatelessWidget {
  const PasscodeUnfilled({Key? key}) : super(key: key);
