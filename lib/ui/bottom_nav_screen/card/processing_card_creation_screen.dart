...
class ProcessingCreationScreen extends StatefulWidget {
  const ProcessingCreationScreen({Key? key}) : super(key: key);

  @override
  State<ProcessingCreationScreen> createState() =>
      _ProcessingCreationScreenState();
}

class _ProcessingCreationScreenState extends State<ProcessingCreationScreen> {
  @override
                  ...
                  child: MainButton(next, () {
                    if (sendMoneyProvider.isSendToAccountNumber) {
                      ...
                      if (sendMoneyProvider.usernameController.text.length <
                        ...
                        // navTo(
                        //     context: context,
                        //     path: Routes.sendMoneySummaryAndConfirmationScreen);
                      }
                    }
                  }),
                ),
