...
class _ChangeCardPINScreenState extends State<ChangeCardPINScreen> {
  ...
  late StreamController<ErrorAnimationType> oldPinErrorController;
  final TextEditingController oldPinTextEditingController =
  ...
  late TapGestureRecognizer oldPinOnTapRecognizer;
  ...
  void initState() {
    ...
    oldPinOnTapRecognizer = TapGestureRecognizer()
      ..onTap = () {
        // Navigator.pop(context);
      };

    oldPinErrorController = StreamController<ErrorAnimationType>();
  ...
  void dispose() {
    ...
    oldPinErrorController.close();
    confirmPinErrorController.close();
    super.dispose();
  }
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          CardPINInputFieldWidget(
                            textEditingController: oldPinTextEditingController,
                            errorController: oldPinErrorController,
                          ...
                          CardPINInputFieldWidget(
                            textEditingController:
                                confirmPinTextEditingController,
                      ...
                      child: MainButton(
                        ...
                        () async {
                          if (pinTextEditingController.text.length == 4 &&
                              ...
                              oldPinTextEditingController.text.length == 4) {
                            final id = cardProvider.selectedNairaCard!.id;
                            (bool, String) result =
                                await cardProvider.changePin(
                                    id: id,
                                    oldPin: oldPinTextEditingController.text,
                                    newPin: pinTextEditingController.text);
