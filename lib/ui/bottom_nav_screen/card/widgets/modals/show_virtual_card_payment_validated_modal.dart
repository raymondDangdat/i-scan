...
Future showVirtualCardPaymentValidatedModal(BuildContext importedContext,
    {bool isTarget = true}) {
            ...
            return Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const TitleWidget(
                      title: yourCardPaymentHasBeenValidated,
                      fontSize: 24,
                    ),
                    SizedBox(
                      height: 4.h,
                    ...
                    const BodyTextLightWithLineHeight(
                      text: pleaseContinueTheRemainingProcess,
                      fontSize: 10,
                    ...
                    MainButton(
                      ...
                      () {
                        ...
                        //TO SHOW OPTION TO LINK CARD FOR FIRST TIME
                        cardProvider.updateCreatedCardFirstTime(true);
                        cardProvider.updateUserHasCardCreated(true);
                        // cardProvider.updateUserHasCardCreated(false);
                      },
                      border: 16,
