...
class ConfirmCardDeliveryDetailScreen extends StatefulWidget {
  const ConfirmCardDeliveryDetailScreen({Key? key}) : super(key: key);

  @override
  State<ConfirmCardDeliveryDetailScreen> createState() =>
      _ConfirmCardDeliveryDetailScreenState();
}

class _ConfirmCardDeliveryDetailScreenState
    extends State<ConfirmCardDeliveryDetailScreen> {
  @override
