...
class Tier2Widget extends StatelessWidget {
  const Tier2Widget({Key? key}) : super(key: key);
              ...
              MainButton(
                ...
                widget: Row(
                  ...
                  children: [
                    ...
                    BodyTextPrimaryWithLineHeight(
                      text: kycInfoProvider.upgradingTierLevel
                          ? "Upgrading..."
                          : "Upgrade to Tier 3",
                      textColor: white,
                      fontWeight: boldFont,
                    ...
                    child: MainButton(
                      ...
                      () async {
                        if (kycInfoProvider.upgradingTierLevel) {
                          ...
                          if (tierUpgraded) {
                            kycInfoProvider.updateIsDisplayNextTierInfo(false);
                            kycInfoProvider.updateCurrentTier(3);
                          }
